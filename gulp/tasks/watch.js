...
gulp.task('watch', () => {
  ...
  // Watch css files
  gulp.watch(paths.app.styles, ['less', browserSync.reload]);//if takes to long, take a look at https://github.com/Browsersync/recipes/tree/master/recipes/gulp.task.sequence
